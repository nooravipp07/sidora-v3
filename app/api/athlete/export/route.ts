...
export async function GET(request: NextRequest) {
    try {
        ...
        const excelData = await athleteService.exportToExcel({
            kecamatanId,
            desaKelurahanId
        });
        ...
        const columns = [
            ...
            'Jenis Kelamin', 'Organisasi', 'Kategori', 'Cabang Olahraga',
            'Alamat', 'Desa/Kelurahan', 'Kecamatan', 'Status', 'Prestasi',
        ...
        const filename = `AthletePrestasi_${new Date().getTime()}.xlsx`;
